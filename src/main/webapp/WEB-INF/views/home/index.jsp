...
$(document).ready(function() {
   ...
   <div id="container">
      ...
      <div class="about_area">
         <h2><a href="/home/board/board_list?board_type=gallery&search_keyword=">겔러리 최근 게시물 <b>TOP 3</b>
         </a></h2>
         <div class="about_box">
            <ul class="place_list box_inner clear">
            <c:forEach var="galleryVO" items="${latestGallery}">
	             <!-- 게시판종류 board_type값은 세션이지만, 여기서 최초로 세션을 발생시켜야 함. -->
      ...
      <div class="appbbs_area">
         <div class="appbbs_box box_inner clear">
            ...
            <div class="bbs_line">
               <h3><a href="/home/board/board_list?board_type=notice&search_kerword=">NOTICE</a></h3>
