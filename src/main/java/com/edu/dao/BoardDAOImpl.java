...
/**
 * 이 클래스는 게시물 CRUD를 구현하는 DAO클래스 임.
 * @author 유지윤
 *
 */
@Repository
public class BoardDAOImpl implements IF_BoardDAO {
	...
	@Inject
	private SqlSession sqlSession;//sql세션템플릿에는 (틀)에는 insert
	@Override
	...
	public void updateAttach(AttachVO attachVO) throws Exception {
		// TODO 아래 주석 동일-첨부파일. 주의사항, 메서드명은 update지만, 쿼리는 insert
	...
	public int insertBoard(BoardVO boardVO) throws Exception {
		// TODO 아래 주석 동일+게시물 입력 후 반환값으로 bno를 받음.
