...
/**
 * 이 클래스는 게시판생성관리 쿼리의 인터페이스를 구현메서드가 있는 클래스 임.
 * @author User
 *
 */
@Repository
public class BoardTypeDAOImpl implements IF_BoardTypeDAO {
	...
	public List<BoardTypeVO> selectBoardType() throws Exception {
		// TODO 매퍼쿼리를 실행 sqlSession 템플릿(틀)을 이용해서 실행.
