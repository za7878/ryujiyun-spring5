 ...
 * 목적은 데이터 변수값 이동시 Get/Set 작업이 주 목적임.
 * @author 유지윤
 *
 */
public class BoardVO {
	...
	//게시물 1개 등록시, 첨부파일 1개이상 필요. 그런데, 1개의 필드에 여러개를 입력할 순 없음.
	//게시물 1개 등록시, 첨부파일 1개 이상 필요. 그런데, 1개의 필드에 여러개를 입력할 순 없음.
	//그래서, DB(테이블)에는 없는 가상 멤버변수(필드)를 2개 만듬.
